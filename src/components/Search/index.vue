...
<div class="search_body">
    ...
    <div class="search_result">
        ...
        <ul>
           <!-- <li>
                <div class="img"><img src="" alt="未找到图片"></div>
                <div class="info">
            ...
            <li v-for="item in moviesList" :key="moviesList.id">
                <div class="img"><img :src="item.img | setWH('168.180')" alt="未找到图片"></div>
                <div class="info">
